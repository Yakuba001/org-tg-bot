...
@Component
public class SetThursdayMorningProbeg extends AbstractRouteCallbackHandler {

    public SetThursdayMorningProbeg(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.SET_MORNING_THURSDAY_KM;
    }
