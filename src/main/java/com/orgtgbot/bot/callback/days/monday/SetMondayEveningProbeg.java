...
@Component
public class SetMondayEveningProbeg extends AbstractRouteCallbackHandler {

    public SetMondayEveningProbeg(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.SET_EVENING_MONDAY_KM;
    }
