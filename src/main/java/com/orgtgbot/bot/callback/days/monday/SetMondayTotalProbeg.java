...
@Component
public class SetMondayTotalProbeg extends AbstractRouteCallbackHandler {

    public SetMondayTotalProbeg(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.SET_TOTAL_MONDAY_KM;
    }
