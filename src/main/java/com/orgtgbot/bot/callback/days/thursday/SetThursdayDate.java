...
@Component
public class SetThursdayDate extends AbstractRouteCallbackHandler {

    public SetThursdayDate(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.THURSDAY_DATE;
    }
