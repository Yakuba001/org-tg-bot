...
@Component
public class SetTuesdayDate extends AbstractRouteCallbackHandler {

    public SetTuesdayDate(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.TUESDAY_DATE;
    }
