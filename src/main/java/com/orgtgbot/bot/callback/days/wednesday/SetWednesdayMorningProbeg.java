...
@Component
public class SetWednesdayMorningProbeg extends AbstractRouteCallbackHandler {

    public SetWednesdayMorningProbeg(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.SET_MORNING_WEDNESDAY_KM;
    }
