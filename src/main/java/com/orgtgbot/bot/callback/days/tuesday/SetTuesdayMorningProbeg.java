...
public class SetTuesdayMorningProbeg implements CallbackHandler {
    ...
    public Buttons callbackData() {
        return Buttons.SET_MORNING_TUESDAY_KM;
    }
    ...
    public void handle(CallbackQuery callbackQuery) throws Exception {
        ...
        sender.editMarkup(
                ...
                Buttons.SET_MORNING_TUESDAY_KM.getName() + ": " + result + " км.",
                KeyboardFactory.probegBack(Buttons.SET_MORNING_TUESDAY_KM)
        );
    }
}
