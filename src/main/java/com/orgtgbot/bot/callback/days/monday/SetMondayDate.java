...
@Component
public class SetMondayDate extends AbstractRouteCallbackHandler {

    public SetMondayDate(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.MONDAY_DATE;
    }
