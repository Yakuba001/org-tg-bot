...
@Component
public class SetMondayRoute extends AbstractRouteCallbackHandler {

    public SetMondayRoute(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.SET_MONDAY_ROUTE;
    }
