...
@Component
public class SetFridayTotalProbeg extends AbstractRouteCallbackHandler {

    public SetFridayTotalProbeg(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.SET_TOTAL_FRIDAY_KM;
    }
