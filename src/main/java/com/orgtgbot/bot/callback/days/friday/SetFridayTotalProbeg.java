...
public class SetFridayTotalProbeg implements CallbackHandler {
    ...
    public Buttons callbackData() {
        return Buttons.SET_TOTAL_FRIDAY_KM;
    }
    ...
    public void handle(CallbackQuery callbackQuery) throws Exception {
        ...
        sender.editMarkup(
                ...
                Buttons.SET_TOTAL_FRIDAY_KM.getName() + ": " + result + " км.",
                KeyboardFactory.probegBack(Buttons.SET_TOTAL_FRIDAY_KM)
        );
    }
}
