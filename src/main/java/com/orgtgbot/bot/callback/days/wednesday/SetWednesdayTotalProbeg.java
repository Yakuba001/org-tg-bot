...
@Component
public class SetWednesdayTotalProbeg extends AbstractRouteCallbackHandler {

    public SetWednesdayTotalProbeg(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.SET_TOTAL_WEDNESDAY_KM;
    }
