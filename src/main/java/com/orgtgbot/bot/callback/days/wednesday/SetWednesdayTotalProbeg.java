...
public class SetWednesdayTotalProbeg implements CallbackHandler {
    ...
    public Buttons callbackData() {
        return Buttons.SET_TOTAL_WEDNESDAY_KM;
    }
    ...
    public void handle(CallbackQuery callbackQuery) throws Exception {
        ...
        sender.editMarkup(
                ...
                Buttons.SET_TOTAL_WEDNESDAY_KM.getName() + result + " km.",
                KeyboardFactory.probegBack(Buttons.SET_TOTAL_WEDNESDAY_KM)
        );
    }
}
