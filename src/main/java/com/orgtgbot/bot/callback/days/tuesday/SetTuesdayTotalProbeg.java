...
@Component
public class SetTuesdayTotalProbeg extends AbstractRouteCallbackHandler {

    public SetTuesdayTotalProbeg(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.SET_TOTAL_TUESDAY_KM;
    }
