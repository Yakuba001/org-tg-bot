package com.orgtgbot.bot.callback.bookkeeper;
...
@Component
public class BookkeeperCallback extends AbstractRouteCallbackHandler {

    protected BookkeeperCallback(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.MAIN_RECEIPT;
    }
