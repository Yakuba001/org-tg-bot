...
public enum GeneralFields {
    ...
    PROBEG_TUESDAY("Вторник", PROBEG_MENU, null, null, null),
    PROBEG_WEDNESDAY("Среда", PROBEG_MENU, null, null, null),
    PROBEG_THURSDAY("Четверг", PROBEG_MENU, null, null, null),
    PROBEG_FRIDAY("Пятница", PROBEG_MENU, null, null, null),

    GET_REPORT("Получить отчёт", PROBEG_MENU, null, null, null),
    CLEAR_ALL("Очистить", PROBEG_MENU, null, null, null),
    ACCEPT_CLEAR("Да", PROBEG_MENU, null, null, null),
    DECLINE_CLEAR("Нет", PROBEG_MENU, null, null, null),
