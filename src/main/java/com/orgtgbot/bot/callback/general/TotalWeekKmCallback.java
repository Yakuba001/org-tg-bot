...
@Component
public class TotalWeekKmCallback extends AbstractRouteCallbackHandler {

    public TotalWeekKmCallback(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.TOTAL_WEEK_KM;
    }
