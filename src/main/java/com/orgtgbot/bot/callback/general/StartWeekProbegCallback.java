...
@Component
public class StartWeekProbegCallback extends AbstractRouteCallbackHandler {

    public StartWeekProbegCallback(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.START_WEEK_PROBEG;
    }
