...
@Component
public class EndBalanceLitersCallback extends AbstractRouteCallbackHandler {

    public EndBalanceLitersCallback(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.END_BALANCE_LITRES;
    }
