...
@Component
public class ModelAutoCallback extends AbstractRouteCallbackHandler {

    public ModelAutoCallback(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.MODEL_AUTO;
    }
