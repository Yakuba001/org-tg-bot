...
@Component
public class FuelNormCallback extends AbstractRouteCallbackHandler {

    public FuelNormCallback(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.FUEL_NORM;
    }
