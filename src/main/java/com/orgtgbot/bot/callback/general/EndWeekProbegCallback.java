...
@Component
public class EndWeekProbegCallback extends AbstractRouteCallbackHandler {

    public EndWeekProbegCallback(TelegramSender sender, BotFacade botFacade) {
        super(sender, botFacade);
    }

    @Override
    public GeneralFields callbackData() {
        return GeneralFields.END_WEEK_PROBEG;
    }
