package com.orgtgbot.bot.state.days.thursday;
...
public class InputThursdayTotalProbeg implements StateHandler {
    ...
    public void handle(Long chatId, String text, Integer botMenuId, TelegramSender sender) {
        if (!text.matches("\\d+")) {
            ...
            probegService.setTotalKm(getSupportedHandle(), Integer.parseInt(text.trim()));
